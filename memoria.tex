...
Bitio es la segunda herramienta que se ha usado para conseguir convertir nuestro Microbit en un controlador, se trata de una libreria de Microbit para Python, como podemos ver en su documentación nos permite correr código de python en nuestro PC y poder interactuar directamente con nuestro Microbit. 
...
A la hora de usar  Python en el microbit necesitamos un editor 
