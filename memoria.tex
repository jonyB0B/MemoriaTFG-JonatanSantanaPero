...
\item Interacción al pulsar los dos botones a la vez del Microbit.
\end{itemize}
...
\begin{figure}[H]
		...
		\caption{Funciones del Microbit}
...
\subsection{Programación del Microbit}
...
Para poder implementar el movimiento de la cámara con el accelerómetro del Microbit, primero es necesario entender como se maneja la cámara en A-Frame con un ratón común.Para mover la cámara es necesario pulsar dentro del escenario de A-Frame y a continuación desplazar el ratón en la dirección deseada sin soltar el botón izquierdo del ratón.

Por tanto lo que se ha hecho en este caso es mapear el movimiento del ratón por la pantalla en base a los valores que ofrece el acelerómetro del Microbit.
...
Ahora se necesita saber como funciona el acelerómetro del Microbit.
